...
<header class="site-header"><a class="brand-lockup" href="index.html" aria-label="Deluxe Manna home">{brand()}</a><nav class="desktop-nav" aria-label="Main navigation">{nav()}</nav><a class="button button-outline header-book" href="index.html#booking">Book a table {icon('arrow')}</a><div class="reading-progress" aria-hidden="true"></div></header>
